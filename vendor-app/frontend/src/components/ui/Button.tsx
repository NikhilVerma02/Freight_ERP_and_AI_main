...
export function Button({ variant = "primary", className = "", children, ...props }: ButtonProps) {
  ...
  const vars = {
    ...
    secondary: "border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 focus:ring-slate-300 dark:border-navy-600 dark:bg-navy-800 dark:text-slate-200 dark:hover:bg-navy-700",
